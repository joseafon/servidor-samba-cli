...
ELIJE UNA OPCION DE CONFIGURACION
...
\e[0m"
                                ...
                                echo
				                    ...
				                    sleep 2
				                        ...
				                        mkdir -p $PWD/publico/"$directorio" 
				                        chmod 777 $PWD/publico/"$directorio"

				                        echo "
["$directorio"]
path = $PWD/publico/"$directorio"
...
" >> /etc/samba/smb.conf
                                        ...
                                        touch $PWD/recursos/"$directorio".conf
...
\e[0m"
		                ...
		                then
			                ...
			                echo
                                ...
                                rm $PWD/recursos/"$directorio".conf
                                ...
                                cat $PWD/recursos/*.conf >> /etc/samba/smb.conf 2>&1
...
\e[0m"
			                ...
			                then
                                ...
                                then
				                    ...
				                    mkdir -p $PWD/privado/$directorio

				                    chgrp $directorio $PWD/privado/$directorio

				                    chmod 770 $PWD/privado/$directorio

                                    # Crea el fichero donde el usuario guarda los grupos a los que pertenece
                                    touch $PWD/grupos/$directorio

				                    echo "
[$directorio]
path = $PWD/privado/$directorio
comment = $comentario
browseable = yes
guest ok = no
writable = yes
...
create mode = 0770
directory mode = 0770
write list = @$directorio" >> $PWD/recursos/$directorio.conf
					                    ...
					                    read directorio
						                    ...
						                    then
                                                ...
                                                then
                                                    ...
                                                    echo "$usuario" >> $PWD/grupos/$directorio
...
\e[0m"
						        ...
						        then
							         ...
							         then
                                         ...
                                         grep -w $usuario $PWD/grupos/$directorio > /dev/null 2>&1
                                         ...
                                         then
                                            ...
                                            linea=$(sed -n '/'$usuario'/=' $PWD/grupos/$directorio)

                                            # Borra la línea donde se encuentra el valor de la variable $línea
                                            sed -i ''$linea'd' $PWD/grupos/$directorio
